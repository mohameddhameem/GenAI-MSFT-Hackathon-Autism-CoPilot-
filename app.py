...
PROMPTFLOW_CHAT_ENDPOINT = os.environ.get("PROMPTFLOW_CHAT_ENDPOINT")
PROMPTFLOW_CHAT_KEY = os.environ.get("PROMPTFLOW_CHAT_KEY")
PROMPTFLOW_EXTRACTION_DETAILS_ENDPOINT = os.environ.get("PROMPTFLOW_EXTRACTION_DETAILS_ENDPOINT")
PROMPTFLOW_EXTRACTION_DETAILS_KEY = os.environ.get("PROMPTFLOW_EXTRACTION_DETAILS_KEY")
PROMPTFLOW_EXTRACTION_SHORT_ENDPOINT = os.environ.get("PROMPTFLOW_EXTRACTION_SHORT_ENDPOINT")
PROMPTFLOW_EXTRACTION_SHORT_KEY = os.environ.get("PROMPTFLOW_EXTRACTION_SHORT_KEY")
...
PROMPTFLOW_DICT = {
    ...
    "key-phrase-details": {
        "endpoint": PROMPTFLOW_EXTRACTION_DETAILS_ENDPOINT,
        "key": PROMPTFLOW_EXTRACTION_DETAILS_KEY
    },
        "key-phrase-short": {
        "endpoint": PROMPTFLOW_EXTRACTION_SHORT_ENDPOINT,
        "key": PROMPTFLOW_EXTRACTION_SHORT_KEY
    },
    "chat": {
        "endpoint": PROMPTFLOW_CHAT_ENDPOINT,
        "key": PROMPTFLOW_CHAT_KEY
    },
    "summarization": {
